...
#fråga hur många olika ord ska man identifiera?
    ...
    highest_wf_words= highest #kanske ska sätta in denna i loopen ovan. Obs att det är en setter-metod som anropas här som är förklädd till att ge värde.
    #Nu...
    ...
    initarray=[]
    nH.each { |k,v| initarray << k if v==highest_wf_words  }
    self.highest_wf_words=([1,2,3]) #initarray #ok, nu förstår jag, det var det där professorn varnade oss om att den inte anropar en funktion utan skapar och sätter en lokal variabel istället.
    #self.highest_wf_words= [1,2,3] #initarray
